...
export default function AcademyPage() {
    ...
    return (
        <main className="relative bg-black min-h-screen text-white">
            {/* Navbar */}
            <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 md:px-12 pt-8 w-full">
            ...
            <section className="py-24 md:py-32 px-6 md:px-12 w-full">
                <div
                    ...
                    className="mb-16"
                >
                    <span className="text-[10px] tracking-[0.2em] text-white/30 font-medium uppercase block mb-4 font-sora">
                        WHAT YOU WILL LEARN
                    </span>
            ...
            {/* Pricing */}
            <section className="py-24 md:py-32 px-6 md:px-12 w-full border-t border-white/8">
                <div
            ...
            {/* CTA */}
            <section className="py-24 md:py-32 px-6 md:px-12 w-full text-center border-t border-white/8">
                <div
                    ref={(el) => { sectionRefs.current[8] = el; }}
                >
                    <h2 className="font-druk text-3xl md:text-5xl uppercase tracking-wide mb-6">
            ...
            {modalOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center px-6">
                    ...
                    <div className="relative bg-black border border-white/10 p-8 md:p-12 max-w-md w-full text-center">
                        <h3 className="font-sora font-bold text-xl md:text-2xl uppercase tracking-wide mb-4">
                            Confirm Enrollment
                        </h3>
                        {selectedPlan ? (
                            <>
